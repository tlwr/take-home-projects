...
func (fake *FakePokemonClient) GetCallCount() int {
	fake.getMutex.RLock()
...
func (fake *FakePokemonClient) GetArgsForCall(i int) string {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
...
func (fake *FakePokemonClient) Invocations() map[string][][]interface{} {
...
func (fake *FakePokemonClient) recordInvocation(key string, args []interface{}) {
...
var _ pokemon.PokemonClient = new(FakePokemonClient)
